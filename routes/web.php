...
// use App\Http\Controllers\WhatsAppTestController; // COMMENTED OUT - Controller không tồn tại
...
// Route::get('/test-whatsapp', [WhatsAppTestController::class, 'testSend']); // COMMENTED OUT - Controller không tồn tại
...
Route::middleware(['web'])->prefix('admin')->group(function () {
    ...
    // Route kiểm tra tin nhắn mới (cho global notification)
    Route::get('whatsapp/check-new', [WhatsAppController::class, 'checkNewMessages'])
        ->name('admin.whatsapp.check-new');
    
    // Route đánh dấu đã đọc (gửi read receipt về WhatsApp)
    Route::post('leads/{id}/whatsapp-mark-read', [WhatsAppController::class, 'markAsRead'])
        ->name('admin.leads.whatsapp.mark-read');
});
