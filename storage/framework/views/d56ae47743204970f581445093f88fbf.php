    ...
    <div class="flex h-[100vh] flex-col items-center justify-center gap-10">
        <div class="flex flex-col items-center gap-5">
            ...
            <?php if($logo = core()->getConfigData('general.design.admin_logo.logo_image')): ?>
                <img class="h-10 w-[110px]" src="<?php echo e(Storage::url($logo)); ?>" alt="<?php echo e(config('app.name')); ?>" />
            <?php else: ?>
                <img class="w-max" src="<?php echo e(vite()->asset('images/logo.svg')); ?>" alt="<?php echo e(config('app.name')); ?>" />
            <?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center justify-between p-4">
                        ...
                        <!-- Submit Button -->
                        <button class="primary-button" aria-label="<?php echo e(trans('admin::app.users.login.submit-btn')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\base_crm1.0\packages\Webkul\Admin\src/resources/views/sessions/login.blade.php ENDPATH**/ ?>