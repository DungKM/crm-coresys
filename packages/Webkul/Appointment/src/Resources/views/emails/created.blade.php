...
@section('title', 'Xác nhận lịch hẹn')
...
@section('content')
    ...
    <p style="font-size: 14px; color: #64748B; margin-bottom: 24px;">
        Cảm ơn bạn đã đặt lịch hẹn với chúng tôi. Dưới đây là thông tin chi tiết về lịch hẹn của bạn:
    </p>
    ...
    <div class="button-group">
        ...
        <a href="{{ $rescheduleUrl }}" class="btn btn-outline">
            Đổi lịch
        </a>
    </div>
    ...
    <p style="font-size: 13px; color: #64748B; text-align: center; line-height: 1.8;">
        Nếu bạn cần thay đổi hoặc hủy lịch hẹn, vui lòng nhấn vào link bên dưới:<br>
        <a href="{{ $cancelUrl }}" style="color: #EF4444; text-decoration: none; font-weight: 600; margin-top: 8px; display: inline-block;">
            Hủy lịch hẹn
        </a>
    </p>
